...
RSS_COLLECTION = get_collection("RSS_YTS")  # Changed Collection Name cuz of Messsssss
TASK_RUNNING = False
...
async def send_new_post(entries):
    ...
    tor = entries.get('links')
    torrent = tor[1].get('href')
